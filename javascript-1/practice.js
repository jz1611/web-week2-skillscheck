...
var doubled = myNumbers.map(function(value){
	return value * 2;
});
...
var filtered = myNumbers.filter(value => value > 100);
...
var total = myNumbers.reduce((acc, value) => acc + value);
...
var enemies = people.filter(person => person.friend === false);
...
var totallyAwesome = people.reduce(function(acc, person) {
	return {awesomeLevel: acc.awesomeLevel + person.awesomeLevel};
}).awesomeLevel;