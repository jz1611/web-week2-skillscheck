...
var faveColors = ['white', 'orange', 'blue'];
...
var me = {
    firstName: 'Jeff',
    superHeroName: 'The Mask',
    homeTown: 'Cleveland',
    superPowers: ['Abundant Agility', 'Invisibility', 'Underwater Breathing'],
    superPowerXP() {
...
function setColor(arr) {
    ...
    background(minColor[0], minColor[1], minColor[2]);
}
